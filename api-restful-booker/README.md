...
[![Newman API Tests](https://github.com/filipjelinek89/QA-Portfolio/actions/workflows/newman.yml/badge.svg)](https://github.com/filipjelinek89/QA-Portfolio/actions/workflows/newman.yml)
...
This project demonstrates a complete API testing workflow from analysis and documentation through automation and CI/CD.# 🏨 Restful Booker API Testing Portfolio
